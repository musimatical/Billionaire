// Code from http://www.mysamplecode.com/2011/12/java-socket-client-example-connect-to.html
// Edited by Benjamin Ding for Billionaire game
...
public class BillionaireClient
{ 
    ...
    { 
        ...
        if(args.length == 0) 
        { 
            System.out.println("Usage : BillionaireClient <serverName>"); 
            return; 
        } 
